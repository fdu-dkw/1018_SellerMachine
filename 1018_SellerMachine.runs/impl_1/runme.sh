...
HD_PWD='D:/Coding/Vivado_workspace/1018_SellerMachine/1018_SellerMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seller_machine_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seller_machine_top.tcl -notrace
