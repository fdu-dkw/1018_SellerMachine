...
HD_PWD='D:/Coding/Vivado_workspace/1018_SellerMachine/1018_SellerMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seller_machine_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seller_machine_top.tcl
